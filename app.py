...
ABOUT_CONTENT = {
    "en": {
        ...
        "mission_text": "Zen-IT Story reconnects children to the real sky, transforming bedtime into a ritual of wonder where real astronomy becomes poetic narrative.\n\nNot random stories: every night, the sky above your city becomes the protagonist.",
        "how_title": "🔮 How It Works",
        "how_steps": [
            "📍 Enter your city to discover what's in YOUR sky tonight",
            "🎯 MCP Server intelligently selects the most interesting celestial object (special events, iconic planets, significant stars)",
            "✨ Google Gemini AI creates a personalized tale where that star/planet speaks to your child",
            "🌸 Every story ends with a haiku that captures the magic of the moment",
        ],
        "features_title": "🎨 Dream Canvas",
        "features": [
            "The creative loop that lasts beyond the night:",
            "🌙 Night → 📖 Story → 💭 Dream → ☀️ Morning → 🎨 Drawing → 💝 Memory",
            "Download printable templates to transform dreams into art worth keeping.",
        ],
        "perfect_title": "💫 Real Value",
        "perfect_for": [
            "🌍 Anchored to reality - Not generic fiction: every story is born from the authentic sky of that evening, in your location",
            "🧠 Intentional screen time - The screen is a tool, not the goal. After the story, look at the real sky together",
            "📚 Educates by inspiring - Real scientific facts (\"Vega is 25 light-years away\") told poetically, not textbook-style",
            "🤝 Meaningful ritual - Creates parent-child moments children will remember growing up",
        ]
    },
    "it": {
        "mission_title": "🌟 Missione",
        "mission_text": "Zen-IT Story riconnette i bambini al cielo vero, trasformando il momento della buonanotte in un rituale di meraviglia dove astronomia reale diventa narrazione poetica.\n\nNon storie casuali: ogni sera, il cielo sopra la tua città diventa protagonista.",
        "how_title": "🔮 Come Funziona",
        "how_steps": [
            "📍 Inserisci la tua città per scoprire cosa c'è nel TUO cielo stasera",
            "🎯 L'MCP Server sceglie intelligentemente l'oggetto celeste più interessante (eventi speciali, pianeti iconici, stelle significative)",
            "✨ Google Gemini AI crea una favola personalizzata dove quella stella/pianeta parla al bambino",
            "🌸 Ogni storia termina con un haiku che cattura la magia del momento",
        ],
        "features_title": "🎨 Dream Canvas",
        "features": [
            "Il loop creativo che dura oltre la notte:",
            "🌙 Notte → 📖 Storia → 💭 Sogno → ☀️ Mattina → 🎨 Disegno → 💝 Ricordo",
            "Scarica template stampabili per trasformare i sogni in arte da conservare.",
        ],
        "perfect_title": "💫 Il Vero Valore",
        "perfect_for": [
            "🌍 Ancoraggio al reale - Non fiction generica: ogni storia nasce dal cielo autentico di quella sera, nella tua posizione",
            "🧠 Screen time intenzionale - Lo schermo è strumento, non fine. Dopo la storia, si guarda il cielo vero insieme",
            "📚 Educa ispirando - Curiosità scientifiche vere (\"Vega è a 25 anni luce\") raccontate con poesia, non da manuale",
            "🤝 Rituale significativo - Crea un momento genitore-figlio che i bambini ricorderanno crescendo",
        ]
    },
    "fr": {
        "mission_title": "🌟 Mission",
        "mission_text": "Zen-IT Story reconnecte les enfants au vrai ciel, transformant le moment du coucher en un rituel d'émerveillement où l'astronomie réelle devient récit poétique.\n\nPas d'histoires aléatoires : chaque soir, le ciel au-dessus de votre ville devient protagoniste.",
        "how_title": "🔮 Comment Ça Marche",
        "how_steps": [
            "📍 Entrez votre ville pour découvrir ce qu'il y a dans VOTRE ciel ce soir",
            "🎯 Le serveur MCP sélectionne intelligemment l'objet céleste le plus intéressant (événements spéciaux, planètes iconiques, étoiles significatives)",
            "✨ Google Gemini AI crée un conte personnalisé où cette étoile/planète parle à votre enfant",
            "🌸 Chaque histoire se termine par un haïku qui capture la magie de l'instant",
        ],
        "features_title": "🎨 Toile de Rêves",
        "features": [
            "La boucle créative qui dure au-delà de la nuit :",
            "🌙 Nuit → 📖 Histoire → 💭 Rêve → ☀️ Matin → 🎨 Dessin → 💝 Souvenir",
            "Téléchargez des modèles imprimables pour transformer les rêves en art à conserver.",
        ],
        "perfect_title": "💫 Vraie Valeur",
        "perfect_for": [
            "🌍 Ancré dans le réel - Pas de fiction générique : chaque histoire naît du ciel authentique de cette soirée, dans votre position",
            "🧠 Temps d'écran intentionnel - L'écran est un outil, pas un but. Après l'histoire, regardez le vrai ciel ensemble",
            "📚 Éduque en inspirant - Vraies curiosités scientifiques (\"Vega est à 25 années-lumière\") racontées poétiquement, pas style manuel",
            "🤝 Rituel significatif - Crée des moments parent-enfant dont les enfants se souviendront en grandissant",
        ]
    },
    "es": {
        "mission_title": "🌟 Misión",
        "mission_text": "Zen-IT Story reconecta a los niños con el cielo real, transformando la hora de dormir en un ritual de asombro donde la astronomía real se convierte en narrativa poética.\n\nNo son historias aleatorias: cada noche, el cielo sobre tu ciudad se convierte en protagonista.",
        "how_title": "🔮 Cómo Funciona",
        "how_steps": [
            "📍 Ingresa tu ciudad para descubrir qué hay en TU cielo esta noche",
            "🎯 El servidor MCP selecciona inteligentemente el objeto celeste más interesante (eventos especiales, planetas icónicos, estrellas significativas)",
            "✨ Google Gemini AI crea un cuento personalizado donde esa estrella/planeta le habla a tu hijo",
            "🌸 Cada historia termina con un haiku que captura la magia del momento",
        ],
        "features_title": "🎨 Lienzo de Sueños",
        "features": [
            "El bucle creativo que dura más allá de la noche:",
            "🌙 Noche → 📖 Historia → 💭 Sueño → ☀️ Mañana → 🎨 Dibujo → 💝 Recuerdo",
            "Descarga plantillas imprimibles para transformar sueños en arte digno de guardar.",
        ],
        "perfect_title": "💫 Valor Real",
        "perfect_for": [
            "🌍 Anclado en la realidad - No ficción genérica: cada historia nace del cielo auténtico de esa tarde, en tu ubicación",
            "🧠 Tiempo de pantalla intencional - La pantalla es herramienta, no fin. Después de la historia, miren el cielo real juntos",
            "📚 Educa inspirando - Datos científicos reales (\"Vega está a 25 años luz\") contados poéticamente, no estilo libro de texto",
            "🤝 Ritual significativo - Crea momentos padre-hijo que los niños recordarán al crecer",
        ]
    }
}
